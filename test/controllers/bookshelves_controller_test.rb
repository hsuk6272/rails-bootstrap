...
class BookshelvesControllerTest < ActionController::TestCase
  ...
  test "should create bookshelf" do
    assert_difference('Bookshelf.count') do
      post :create, bookshelf: { author: @bookshelf.author, string: @bookshelf.string, string: @bookshelf.string, title: @bookshelf.title }
    end
  ...
  test "should update bookshelf" do
    patch :update, id: @bookshelf, bookshelf: { author: @bookshelf.author, string: @bookshelf.string, string: @bookshelf.string, title: @bookshelf.title }
    assert_redirected_to bookshelf_path(assigns(:bookshelf))
  end
